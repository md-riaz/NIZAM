<x-ui.table id="extensions-table">
    ...
    @forelse($extensions as $extension)
        <tr>
            ...
            <td class="px-3 py-2">
                <form method="POST" hx-delete="{{ route('ui.extensions.destroy', ['tenant' => $tenant, 'extension' => $extension]) }}" hx-target="#extensions-table" hx-swap="outerHTML" hx-confirm="Delete extension {{ $extension->extension }}?">
                    @csrf
    ...
    @empty
        <tr><td colspan="4" class="px-3 py-6 text-center text-sm"><p>No extensions</p></td></tr>
    @endforelse
    </tbody>
</x-ui.table>
