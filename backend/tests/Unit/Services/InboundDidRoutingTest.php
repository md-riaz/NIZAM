...
class InboundDidRoutingTest extends TestCase
{
    ...
    {
        $tenant = Tenant::factory()->create(['domain' => 'preset.example.com']);
    ...
    {
        $tenant = Tenant::factory()->create(['domain' => 'preset-entry.example.com']);
        $extension = Extension::factory()->create([
            'tenant_id' => $tenant->id,
            'is_active' => true,
        ]);
    ...
    {
        $tenant = Tenant::factory()->create(['domain' => 'flow-entry.example.com']);
        $flow = \App\Models\Flow::factory()->create([
            'tenant_id' => $tenant->id,
