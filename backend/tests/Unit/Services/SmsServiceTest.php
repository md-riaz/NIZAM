...
class SmsServiceTest extends TestCase
{
    public function test_it_routes_to_preferred_provider_and_records_sent_message(): void
    {
        ...
        $this->assertCount(1, $service->historyForTenant('tenant.example.com'));
    }
    ...
    public function test_store_filters_history_by_tenant_domain(): void
    {
        $router = new SmsRouter([
            'signalwire' => new class implements SmsAdapterInterface {
                public function name(): string
        ...
        $this->assertCount(1, $service->historyForTenant('a.example.com'));
        $this->assertCount(1, $service->historyForTenant('b.example.com'));
    }
}
