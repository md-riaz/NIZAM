...
class UpdateCallRoutingPolicyRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'match_destination_type' => 'sometimes|string|in:extension,ivr,voicemail,flow,bridge',
            'match_destination_id' => 'sometimes|uuid',
            'no_match_destination_type' => 'nullable|string|in:extension,ivr,voicemail,flow,bridge',
