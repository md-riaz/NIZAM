...
return new class extends Migration
{
    ...
    private array $requiredIndexes = [
        ...
        'dids' => ['gateway_id'],
        'users' => ['tenant_id', 'schedule_id', 'holiday_calendar_id'],
        'teams' => ['schedule_id', 'holiday_calendar_id'],
        'tenants' => ['default_schedule_id', 'default_holiday_calendar_id'],
        'agents' => ['extension_id'],
        'queues' => ['tenant_id'],
        'queue_members' => ['agent_id'],
        'queue_metrics' => ['tenant_id', 'queue_id'],
        ...
        'flow_compiled_artifacts' => ['tenant_id'],
