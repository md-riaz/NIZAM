-- nizam_ring_team.lua
-- Helper script for team routing in NIZAM flows
...
if not dial_string or dial_string == "" then
    freeswitch.consoleLog("WARNING", "[nizam_ring_team] Empty dial string, treating as no_answer\n")
...
freeswitch.consoleLog("INFO", "[nizam_ring_team] Bridging to team: " .. dial_string .. "\n")
...
freeswitch.consoleLog("INFO", "[nizam_ring_team] Bridge disposition: " .. disposition .. "\n")
